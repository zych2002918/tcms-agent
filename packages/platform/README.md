...
| 门禁 | 结果 | 说明 |
|---|---|---|
| `pytest -q` | **302 passed + 1 skipped** | 检索 14 golden、诊断 8 golden、30 条对抗集、图谱通道契约、上游路径护栏、多轮/澄清/MCP/function-calling 契约… |
...
```bash
python -m pytest tests -q                 # 302 passed + 1 skipped
