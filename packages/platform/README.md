...
[![pytest](https://img.shields.io/badge/pytest-255%20passed-2dd4a0)](#测试--门禁)
...
| 门禁 | 结果 | 说明 |
|---|---|---|
| `pytest -q` | **255 passed + 1 skipped** | 检索 14 golden、诊断 8 golden、30 条对抗集、图谱通道契约、上游路径护栏、多轮/澄清/MCP/function-calling 契约… |
