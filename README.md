...
[![tests](https://img.shields.io/badge/tests-1659%20passed-2dd4a0)](#测试与门禁)
...
| **agent** | `pytest -q` | 含**评测回归门禁**：规则臂 ≥10/11 且零幻觉（174 passed + 2 skipped） |
| 全仓 | `uv run pytest`（仓库根） | 一把梭：**1659 passed + 4 skipped** |
