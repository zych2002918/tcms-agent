...
[![tests](https://img.shields.io/badge/tests-1721%20passed-2dd4a0)](#测试与门禁)
...
| platform | `pytest -q` | ruff + pytest + vitest（379 passed + 1 skipped） |
...
| 全仓 | `uv run pytest`（仓库根） | 一把梭：**1721 passed + 4 skipped** |
