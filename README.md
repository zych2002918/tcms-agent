...
[![tests](https://img.shields.io/badge/tests-1578%20passed-2dd4a0)](#测试与门禁)
...
| platform | `pytest -q` | ruff + pytest + vitest（279 passed + 1 skipped） |
...
| 全仓 | `uv run pytest`（仓库根） | 一把梭：**1578 passed + 4 skipped** |
